const courses = [
  ...
  { name: "Giáo dục thể chất 2", credit: 1 },
  ...
  { name: "Kỹ thuật xử lý ảnh", credit: 3 },
  { name: "Cấu trúc dữ liệu và giải thuật", credit: 3 },
  { name: "Lập trình hướng đối tượng", credit: 2 },
  { name: "Thiết kế đồ họa với Corel Draw", credit: 2 },
  { name: "Thiết kế đồ họa với Illustrator", credit: 3 },
  { name: "Giáo dục thể chất 3", credit: 2 },
  { name: "Giáo dục thể chất 4", credit: 2 },
  { name: "Chủ nghĩa xã hội khoa học", credit: 3 },
  { name: "Tổ chức quản lý sản xuất", credit: 2 },
  { name: "Thiết kế web", credit: 3 },
  { name: "Hệ quản trị cơ sở dữ liệu", credit: 2 },
  { name: "Thực hành đồ họa ứng dụng", credit: 3 },
  { name: "Toán chuyên đề 2", credit: 3 },
  { name: "Nhập môn khoa học giao tiếp", credit: 3 },
  { name: "Cơ sở dữ liệu phân tán", credit: 2 },
  { name: "Cơ sở dữ liệu hiện đại", credit: 3 },
  { name: "Tâm lý học", credit: 2 },
  { name: "Tư tưởng Hồ Chí Minh", credit: 3 },
  ...
  { name: "Kỹ thuật xử lý video", credit: 3 },
  { name: "Chế bản điện tử", credit: 2 },
  { name: "Lịch sử Đảng Cộng sản Việt Nam", credit: 3 },
  { name: "Toán rời rạc", credit: 2 },
  { name: "Hệ điều hành mạng", credit: 3 },
  { name: "Lập trình ứng dụng với Java", credit: 3 },
  { name: "Thiết kế mạng", credit: 2 },
  ...
  { name: "Lập trình Web", credit: 2 },
  { name: "Phát triển ứng dụng trên thiết bị di động", credit: 3 },
  { name: "Lập trình Game", credit: 3 },
  { name: "JavaScripts", credit: 3 },
  { name: "Thực hành thiết kế, quản trị và bảo trì hệ thống mạng", credit: 2 },
  { name: "Thực hành phát triển ứng dụng web", credit: 3 },
  { name: "Đồ án chuyên môn công nghệ thông tin", credit: 3 },
